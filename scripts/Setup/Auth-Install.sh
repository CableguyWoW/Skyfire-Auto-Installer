...
cmake /home/$SETUP_AUTH_USER/Skyfire/ -DCMAKE_INSTALL_PREFIX=/home/$SETUP_AUTH_USER/server -DSCRIPTS="none" -DUSE_COREPCH=1 -DUSE_SCRIPTPCH=1 -DSERVERS=1 -DTOOLS=0 -DCMAKE_BUILD_TYPE=Release -DWITH_COREDEBUG=0 -DWITH_WARNINGS=0 -DSCRIPTS_COMMANDS="none" -DSCRIPTS_SPELLS="none" -DSCRIPTS_CUSTOM="none" -DSCRIPTS_EASTERNKINGDOMS="none" -DSCRIPTS_EVENTS="none" -DSCRIPTS_KALIMDOR="none" -DSCRIPTS_MAELSTROM="none" -DSCRIPTS_NORTHREND="none" -DSCRIPTS_OUTDOORPVP="none" -DSCRIPTS_OUTLAND="none" -DSCRIPTS_PANDARIA="none" -DSCRIPTS_PET="none" -DSCRIPTS_WORLD="none"
make -j $(( $(nproc) - 1 ))
make install
fi
